...
// текст подсказки
var custom_callback_tooltip_text = 'Акция! Скидки до 15% при заказе. Оставьте заявку и закрепите скидку!';
...
// заголовок в окне
var custom_callback_modal_title = 'Бесплатно проконсультируем и подберем подходящего специалиста!<br>Оставьте заявку, перезвоним в течение 5 минут!';
// подзаголовок в окне
var custom_callback_modal_subtitle = 'Сделаем качественно, с гарантией! При заказе с сайта скидки до 15%';
// текст на кнопке формы в окне
var custom_callback_modal_form_btn = 'Оставить заявку';
// текст согласия на обработку данных
var custom_callback_modal_agreement_text = 'Нажимая на кнопку "Оставить заявку", вы принимаете условия <a target="_blank" rel="noopener noreferrer nofollow" href="/soglasie" class="nobr">Согласия</a> и <a target="_blank" rel="noopener noreferrer nofollow" href="/privacy-policy">Политики конфи&shy;ден&shy;циаль&shy;ности</a>.';
// адрес файла обработчика формы
var custom_callback_modal_form_action = 'wp-content/themes/z7_masterbyt/callback/send/send.html';
