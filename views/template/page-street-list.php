...
<div class="container content">
    <div class="row">
        ...
        <?php require_once __DIR__.'/../layouts/include/breadcrumbs.php'; ?>
            ...
            <?php if (!empty($street)): ?>
                <ul>
                    <?php foreach ($street as $one): ?>
                        <?php if (is_array($one) && !empty($one[1])): ?>
                            <li><a href="<?= UrlHelper::to(['page' => "/address/{$one[1]}/"]) ?>"><?= $one[0] ?></a></li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </ul>
            <?php endif; ?>
            ...
            <?php require_once __DIR__.'/../layouts/include/how-we-work-2.php'; ?>
