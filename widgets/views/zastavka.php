            ...
            <div class="zastavka-right">
                <div class="zastavka-right-top">
                    <div class="zastavka-title">
                        <h1>Муж на час</h1><b>Стоимость услуг от 100 руб.</b>
                    </div>
                ...
                <div class="zastavka-right-bottom">
                    ...
                    <div class="zastavka-right-bottom-right">
                        <div class="zastavka-form">
                            ...
                            <!--                     <form action="javascript:void(null);" id="leadbackForm" class="leadback-popup__form">-->
                            <!--                        <input type="text" name="isBotChecker" style="display: none !important;">-->
                            <!--                        <input class="zastavka-form-input" type="tel" name="phone" inputmode="tel" id="ZastavkaTel" placeholder="Ваш телефон"-->
                            <!--                               data-inputmask="'mask': '+7 (999) 999-99-99'"-->
                            <!--                               required/>-->
                            <!--                        <button class="leadback__form-btn g-recaptcha" id="leadbackBtn" type="submit"-->
